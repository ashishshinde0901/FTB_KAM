      ...
      <div className="p-6">
        <div className="flex justify-between items-start">
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-white bg-gray-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors shadow-sm"
          >
            + New Project
          </button>
        </div>
